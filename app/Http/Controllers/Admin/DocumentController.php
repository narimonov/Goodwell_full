...
class DocumentController extends Controller
{
    ...
    public function index()
    {
        ...
        $documents2 = Document::all();
          ...
          foreach ($documents as  $document) {
            if ($document->project_id < 3 ) {
              $documents = Document::orderBy('id', 'desc')->take(1)->where('project_id', '2')->get();
              $documents2 = Document::orderBy('id', 'desc')->take(1)->where('project_id', '1')->get();
            }
          }
        return view('admin.documents.index', compact('documents','documents2'));
    }
    public function index2()
    {
        abort_if(Gate::denies('document_access'), Response::HTTP_FORBIDDEN, '403 Forbidden');

        $documents = Document::orderBy('id', 'desc')->take(2)->latest()->get();

        return view('admin.documents2.index', compact('documents'));
    }
    ...
    public function create2()
    {
        ...
        return view('admin.documents2.create', compact('projects'));
    }
    ...
    public function edit(Document $document , User $user)
    {
    ...
    public function update(UpdateDocumentRequest $req, Document $document)
    {
      ...
      if ($req->input('document_file', false)) {
