                                  ...
                                  <table class=" table table-bordered table-striped table-hover datatable datatable-User">
                                      <thead>
                                          <tr>
                                              ...
                                              <th>
                                                  {{ trans('cruds.user.fields.download') }}
                                              </th>
                                              ...
                                              <tr data-entry-id="{{ $user->id }}">
                                                  ...
                                                  <td>
                                                    @if($user->userDocument)
                                                      <i class="fa fa-check-circle" aria-hidden="true" style="color:green;padding-left:2.7em"></i>
                                                      <span>Загрузил</span>
                                                    @else
                                                      <i class="fa fa-times-circle" aria-hidden="true" style="color:red;padding-left:2.7em"></i>
