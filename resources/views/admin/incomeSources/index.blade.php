            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-IncomeSource">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.incomeSource.fields.file') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($incomeSources as $key => $incomeSource)
                        <tr data-entry-id="{{ $incomeSource->id }}">
                            ...
                            <td>
                                <a href="{{ $incomeSource->file }}" download target="_blank">
                                    <button type="button" class="btn btn-success" name="button">{{ trans('cruds.incomeSource.fields.download') }}</button>
                                </a>
                            </td>
                            <td>
