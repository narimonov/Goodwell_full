...
@can('document_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route("admin.test.create") }}">
                        ...
                        <tr data-entry-id="{{ $document->id }}">
                            ...
                            <td>
                                    <a href="{{ $document->xlsx }}" download target="_blank">
                                        <button type="button" class="btn btn-success" name="button">doc</button>
                                    </a>
                            </td>
                            <td>
