...
@can('document_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route("admin.doc.create") }}">
                ...
                <tbody>
                  ...
                  <?php if ($document->project_id == 4): ?>
                        <tr data-entry-id="{{ $document->id }}">
                            ...
                            <td>
                                    <a href="{{ $document->xlsx }}" download target="_blank">
                        ...
                        <tr data-entry-id="{{ $document->id }}">
                            ...
                            <td>
                                    <a href="{{ $document->pdf }}" download target="_blank">
                        ...
                        <tr data-entry-id="{{ $document->id }}">
                            ...
                            <td>
                                    <a href="{{ $document->json }}" download target="_blank">
                        ...
                        <tr data-entry-id="{{ $document->id }}">
                            ...
                            <td>
                                    <a href="{{ $document->txt }}" download target="_blank">
                      ...
                      <tbody>
                        ...
                        <?php if ($document->project_id == 3): ?>
                              ...
                              <tr data-entry-id="{{ $document->id }}">
                                  ...
                                  <td>
                                          <a href="{{ $document->pdf }}" download target="_blank">
                                              <button type="button" class="btn btn-danger" name="button">PDF</button>
                                          </a>
                                  </td>
                                  <td>
                                      {{ $document->description }}
