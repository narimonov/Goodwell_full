...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" data-widget="pushmenu" onclick="myFunction()" href="#"><i class="fa fa-bars"></i></a>
                </li>
            </ul>

            <div id="myDIV" style="display:none">
            <img src="{{asset('./img/logo.jpg')}}" alt="" style="width:2em">  
            </div>
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                      <p style="padding-left:1.2em;padding-right:1.1em">Отдел ОД</p> <a class="dropdown-item" href="tel:+9989796867" style="padding-left:1.2em;padding-right:1.1em"><i class="fa fa-phone"></i>   +9989796867 </a>
                      <hr>
                      <p style="padding-left:1.2em;padding-right:1.1em">Отдел ФТ</p> <a class="dropdown-item" href="tel:+99998777990" style="padding-left:1.2em;padding-right:1.1em"><i class="fa fa-phone"></i>   +99898777990</a>
                        <hr>
                    <p style="padding-left:1.2em;padding-right:1.1em">Отдел Методологии</p>  <a class="dropdown-item" href="tel:+99876896879" style="padding-left:1.2em;padding-right:1.1em"><i class="fa fa-phone"></i>   +99876896879</a>
                    <hr>
                    <p style="padding-left:1.2em;padding-right:1.1em">Отдел СОИ</p>
                    <a class="dropdown-item" href="tel:+99876896879" style="padding-left:1.2em;padding-right:1.1em"><i class="fa fa-phone"></i>   +99876896879</a>
                    </div>
                </li>
            </ul>
  ...
  $.fn.dataTable.ext.classes.sPageButton = '';
    ...
    @yield('scripts')
    <script>
window.replainSettings = { id: '50786239-309c-4de5-a874-b9206301c3c0' };
